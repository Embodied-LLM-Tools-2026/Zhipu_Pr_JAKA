...
Usage example:
  python test/orbbec_vlm_tracker.py --target-name "红色水杯"

Prerequisites:
  - pyorbbecsdk correctly installed and the camera connected.
  - OpenCV built with the CSRT tracker (opencv-contrib).
  - dashscope + tools/upload_image configured with Zhipu_real_demo_API_KEY.
"""
...
from voice.config import Config as AppConfig  # type: ignore
